...
import br.com.nofrontier.sgetea.web.services.StudentService;
...
//---------------------------------------------------------------------------------------------------------
	...
	public ModelAndView findById(@PathVariable Long userId) {
		var modelAndView = new ModelAndView("/admin/student/student_list");
		modelAndView.addObject("students", studentService.findById(userId));
		return modelAndView;
	}
...
//---------------------------------------------------------------------------------------------------------
	...
	public ModelAndView update(@PathVariable Long id) {
		var modelAndView = new ModelAndView("/admin/student/student_form");
		modelAndView.addObject("studentForm", studentService.findById(id));
		return modelAndView;
	}
