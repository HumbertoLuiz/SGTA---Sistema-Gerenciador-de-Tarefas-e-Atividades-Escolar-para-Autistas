...
CREATE TABLE `confirmation_token` (
  ...
  KEY `FK4lap1fufprxl61a6hhi4n38y6` (`user_id`),
  CONSTRAINT `FK4lap1fufprxl61a6hhi4n38y6` FOREIGN KEY (`user_id`) REFERENCES `usuario` (`user_id`)
...
-- Dump completed on 2021-11-26 13:10:14
