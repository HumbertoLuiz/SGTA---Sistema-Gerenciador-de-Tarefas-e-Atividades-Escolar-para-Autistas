...
import br.com.nofrontier.sgetea.core.filters.AccessTokenRequestFilter;
...
public class SecurityConfig {
	...
	@Value("${br.com.nofrontier.rememberMe.key}")
	private String rememberMeKey;

	@Value("${br.com.nofrontier.rememberMe.validitySeconds}")
